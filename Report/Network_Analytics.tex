...
Per ogni file, viene leggo riga per riga il contenuto e viene fatto votare ogni membro rispetto al nome che vorrebbe dare all'alleanza: ogni giocatore vorrà votare con il nome della community di cui faceva parte al giorno precedente, se ne faceva parte (assumiamo che ogni giocatore voglia rimanere nella stessa alleanza).
